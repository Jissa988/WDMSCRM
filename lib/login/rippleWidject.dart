...
import 'package:customer_portal/login/rippleIsolate.dart';
import 'package:customer_portal/login/rippleRenderObject.dart';
...
class _RippleEffectState extends State<RippleEffect> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (widget.behavior == RippleEffectBehavior.none && widget.rippleController != null) {
